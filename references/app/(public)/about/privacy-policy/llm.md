...
name: Privacy Policy
title: Privacy Policy - Teamily AI
description: Renders the privacy-policy markdown (data collection, use, protection, retention, and user privacy rights) with a desktop table-of-contents sidebar, copy-link headings, and the shared site footer.
relationship:
  upstream: "/, /i/[invite_code], /login, /pricing, /region-restricted, /settings, /support"
  downstream: "/, /pricing, /about, /about/help-center, /about/terms-of-service"
cta:
  "Table of contents":
    type: nav
    trigger: click
  ...
  "Site footer":
    ...
    items:
      ...
      "Privacy Policy":
        type: link
        trigger: click
        description: "Navigates to /about/privacy-policy (this page)."
      "Terms of Service":
        type: link
        trigger: click
