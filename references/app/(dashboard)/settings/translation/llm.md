...
name: Translation
title: Translation
description: Translation settings page that reuses the LanguageSettings component — two independent language pickers (the System/UI locale and the Chat auto-translation target language, drawn from different supported-language sets) plus an auto-translate master toggle.
relationship:
  upstream: "/, /settings"
  downstream: ""
cta:
